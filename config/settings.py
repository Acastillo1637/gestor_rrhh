...
Archivo generado originalmente con 'django-admin startproject' de Django 4.2.

Documentación general de la configuración:
https://docs.djangoproject.com/en/4.2/topics/settings/

Lista completa de opciones y sus valores:
...
# Tipo predeterminado para la clave primaria
